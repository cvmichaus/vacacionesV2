 ...
 function ejecuta_ajax(archivo, parametros, capa){
  ...
  var fecha1 = document.getElementById("dateini").value;
  var fecha2 = document.getElementById("datefin").value;

    // enviarDatos();
              var url = "ValidaFechas2.php";
        $.ajax({                        
           type: "POST",                 
           url: url,                     
  ...
  function ocultaboton(){
     document.getElementById("btnsol").style.visibility = "hidden";
...
function restadias(){
  ...
  if(diasperiodoant == null){
      diasperiodoant = 0;
  }else{
   diasperiodoant = document.getElementById('diasperiodoant').value;
  }
        ...
        if(parseInt(diasperiodoant)  >= 1 ){
            ...
            //alert("Dias Vacaciones + Dias Ant " + diastotalesPHP );
                  ...
                  alert("No puedes Solicitar más días de los que tienes disponibles, si requieres días anticipadas favor de pasar a Recursos Humanos.");
