	...
	<?php
      ...
      $fecha_del_dia=date('Y-m-d');//fecha actual 
	   $resultado = $_GET['y'] ;
        ...
        <input style="width:50px;text-align: center;vertical-align: middle;" type="text" id="ant_anios2" name="ant_anio2s" readonly="readonly" placeholder="Antiguedad" value='<?php echo $fecha->y; ; ?>'>Años
        ...
        <div class="col-md-9 col-sm-9 col-xs-9">
        <input style="width:50px;text-align: center;vertical-align: middle;" type="text" id="ant_mes2" name="ant_mes2" readonly="readonly" placeholder="Antiguedad" value='<?php echo  $fecha->m; ;?>'>Meses 
        ...
        <div class="col-md-9 col-sm-9 col-xs-9">
<input style="width:50px;text-align: center;vertical-align: middle;" type="text" id="ant_dias2" name="ant_dias2" readonly="readonly" placeholder="Antiguedad" value='<?php echo  $fecha->d; ;?>'>Dias
