...
session_start();
  if($_SESSION["logueado"] == TRUE) {
      ...
      $sqlDAtosU = "SELECT * FROM `tbl_usuarios` as u INNER JOIN tbl_empleados as e ON u.CodUsuario = e.CodUsu INNER JOIN tbl_vacacionesxusuarios as v ON v.CodEmpleado = e.CodUsu WHERE u.CodUsuario = '".$ClaveUsuario."' ";
...
?>
	...
	<form  class="form-horizontal form-label-left" action="modpass.php" method="post" accept-charset="utf-8" >
		...
		<h2>Modificar Contraseña del Usuario <br>
      <?php echo $dataDU["Nombres"]; echo " "; echo $dataDU["ApellidoPaterno"];  echo " "; echo $dataDU["ApellidoMaterno"]; ?></h2>
