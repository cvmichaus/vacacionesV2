      ...
      <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                   ...
                   <li><a href="index.php" class="waves-effect  active"> <span class="hide-menu">Inicio</span></a></li>
                    ...
                    <li><a onclick="ejecuta_ajax('formusuario.php','','ventana');"  data-toggle="modal" data-target="#myModal" class="waves-effect"> <span class="hide-menu">Alta de Usuario <span class="fa arrow"></span></span></a>
    ...
    <tbody>
     ...
     if($resQryConsulta01 = $mysqli->query($qryConsulta01)) {
          ...
          <td>
            ...
            <button type="button" class="btn btn-round btn-warning btn-sm" onclick="ejecuta_ajax('detalles.php','cod=<?php echo $data['CodUsu']; ?>','ventana');"  class="btn btn-link" data-toggle="modal" data-target="#myModal">Detalles </button>
             &nbsp;&nbsp;
