...
session_start();
  if($_SESSION["logueado"] == TRUE) {
     ...
     $sqlObtenerDias = "SELECT * FROM `tbl_vacacionesxusuarios` as e WHERE  e.CodEmpleado = ".$iduser."  ";
                ...
                $diasTotales= $rowDias['DiasTotales'];
                      ...
                      if($diasTotales <> 0 ){
                        ...
                        <form class="form-horizontal form-label-left" action="updatesolicitud.php" method="post" name="formulario" id="formulario">
     <input id="CodEmpleado" name="CodEmpleado" type="hidden" value="<?php echo $iduser; ?>">
                        ...
                        <input id="dateini" name="dateini" type="date" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" class="form-control" data-inputmask="" min="<?php echo date("Y-m-d");?>" value="<?php echo  $FechaInicioPHP; ?>">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                        <input id="datefin" name="datefin" type="date" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" class="form-control" data-inputmask=""  min="<?php echo date("Y-m-d");?>" value="<?php echo  $FechaFinPHP; ?>" onblur="valFechas();" >
 ...
 <input id="btnsol" name="btnsol"  type="submit" value="MODIFICAR SOLICITUD" style="visibility:hidden;" class="btn btn-primary">
                        </div>
                      </div>
