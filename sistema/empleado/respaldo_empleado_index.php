      ...
      ?>
          ...
          ?>
            ...
            <td><?php echo $data['aniosA']; echo " Años"; echo " - "; echo $data['mesesA']; echo " Meses"; echo " - "; echo $data['diasA']; echo " Dias"; ?></td>
             <td>
              <?php
                 $qryConsulta04 = "SELECT * FROM `periodoanterior` WHERE CodEmpleado =  ".$iduser." ";
            ...
            <td><?php echo $data['DiasVac']; ?></td>
              ...
              <td>
              <?php
              $qryConsulta02 = "SELECT DiasVac as DiasVacDisponibles,DiasTomados,DiasTotales FROM tbl_vacacionesxusuarios WHERE CodEmpleado = ".$iduser." ";
                  if($resQryConsulta02 = $mysqli->query($qryConsulta02)) {
                      $dataCons02 = mysqli_fetch_assoc($resQryConsulta02);  
                      echo $data['DiasVac']  - $dataCons02['DiasTomados'] + $DiasVacAntPHP;                  
                  }
...
<table id="example3"  cellspacing="0" class="display nowrap table  table-bordered" style="width: 100%;">
					...
					<tbody>
							...
							while($row = mysqli_fetch_assoc($resqryUsuarios)){  
									...
									$estilo = 'text-align: center;vertical-align: middle;font-size: .8em; background-color: green; color:white;';
									}
									else if($EstatusPHP == 2){ 
									$estilo = 'text-align: center;vertical-align: middle;font-size: .8em; background-color: yellow; color:white;';
									}
...
<div class="modal fade" id="mostrarmodal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
         ...
         <div class="modal-body">
            ...
            Tienes  <span style="color: green;font-weight: bolder;"> <?php  echo $datos01['DiasTotales']; ?>  Dias de Vacaciones  del Periodo <?php echo $FechaInicioVacAct2; ?>  al <?php echo $FechaFinVacAct2; ?> y vencen el <?php echo $VigenciaPeriodoActual2; ?></span>
     ...
     if($resQryConsulta01 = $mysqli->query($qryConsulta01)) {
                           ...
                           echo " , y tienes ".$DiasVacAntPHP." Dias del Periodo ".$FechaInicioVacAnt2." al ".$FechaFinVacAnt2.", y vencen el ".$fecha2." .";
                                            }
